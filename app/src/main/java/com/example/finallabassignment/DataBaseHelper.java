...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    boolean addUser(String firstName, String lastName, String address, String phone){
    ...
    boolean updateUser(int id,String firstname, String lastname, String address, int phone) {
        SQLiteDatabase sqLiteDatabase = getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_FIRST_NAME, firstname);
        cv.put(COLUMN_LAST_NAME, lastname);
